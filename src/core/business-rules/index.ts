 ...
 *  - Результат outcome: 'requiresHumanDecision' и/или RuleResult.humanDecisionRequired
 *    сигнализируют, что окончательное решение обязан принять человек —
 *    движок никогда не принимает юридически значимое решение самостоятельно.
